...
- [lara-basic](#lara-basic)
  ...
  - [Layout-View](#layout-view)
    ...
    - [Layout-view with example controller](#layout-view-with-example-controller)
  - [CRUD with a single model](#crud-with-a-single-model)
    - [Route](#route)
    - [Migration](#migration)
    - [Model](#model)
      - [Seeder](#seeder)
        - [single seed](#single-seed)
        - [multiple seeds using faker](#multiple-seeds-using-faker)
    - [View](#view)
      - [index](#index)
      - [create](#create)
      - [edit](#edit)
    ...
    - [Controller](#controller)
      ...
      - [update](#update)
      - [delete](#delete)
  - [Pagination with BS4](#pagination-with-bs4)
  - [CRUD with multiple models](#crud-with-multiple-models)
    - [move models to app/Models](#move-models-to-appmodels)
    - [Controllers, Models & Migrations](#controllers-models-migrations)
      - [Long way](#long-way)
      - [Short way](#short-way)
    - [Prepare Models & Tables](#prepare-models-tables)
    - [View & Controller](#view-controller)
    - [set route](#set-route)
      - [other migration-files](#other-migration-files)
  ...
  - [Sticky Forms](#sticky-forms)
  - [AJAX](#ajax)
    - [Exception-Handling for Ajax](#exception-handling-for-ajax)
    - [create js](#create-js)
    - [BS-confirm-modal](#bs-confirm-modal)
      - [exchange delete-form in Example](#exchange-delete-form-in-example)
  ...
  - [Custom Error Messages](#custom-error-messages)
    - [simple: create validator manually](#simple-create-validator-manually)
  - [more complex: form request](#more-complex-form-request)
  - [Adding Authentication & Authorization](#adding-authentication-authorization)
  - [TODO](#todo)
...
- [Table of contents generator](http://tableofcontents.herokuapp.com/)
